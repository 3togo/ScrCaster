...
import io.github.togo3.scrcaster.isTelevision
...
import io.github.togo3.scrcaster.widgets.VideoOutputTarget
import io.github.togo3.scrcaster.widgets.VideoOutputTargetState
...
fun StreamScreen(activity: StreamActivity) {
    ...
    LaunchedEffect(
        ...
        if (activity.tvReceiverMode) return@LaunchedEffect
